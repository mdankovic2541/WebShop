...
<body>
  ...
  <main>
      <h1><?php echo $navbarSpol;
      echo $GLOBALS['navbarVrsta'];
      echo $GLOBALS['navbarKolekcija'];
        ...
        <div class="row">
          <div class="col-md-3 text-white">
            ...
            <div class="col-md-9 pt-3">
                <div class= "row">
                <?php
                $sql = "SELECT naziv, velicina, cijena, marka, tip FROM artikl WHERE vrsta='$GLOBALS[navbarVrsta]' AND spol ='$GLOBALS[navbarSpol]' AND kolekcija = '$GLOBALS[navbarKolekcija]'";
