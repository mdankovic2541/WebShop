    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="col-md-9 pt-3">
                <div class= "row">
                <?php
                $sql = "SELECT naziv, velicina, cijena, marka, tip, id FROM artikl WHERE vrsta='ženska' AND kolekcija ='proljeće'";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        <p class="text-center text-white">Veličina: <span id="artikl_'.$index_id.'_velicina">' .$row['velicina']. '</span></p>
                        ...
                        <a class="btn btn-sm btn-warning mb-2 dodajUKosaricu" href="dodajProizvodUKosaricu.php?id='. $row['id'].'" onclick="appendId('. $row['id'] .')" ><i class="fas fa-cart-plus"></i>&nbsp;Dodaj u košaricu</a>
