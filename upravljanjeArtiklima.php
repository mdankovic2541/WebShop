  ...
  <main>
      <div class="container-fluid">
          <div class="row">
                ...
                <a href="dodaj.php" class="btn btn-info">Dodaj</a>
                            ...
                            echo '
                                    <tr>
                                        <td >' . $line['id'] .'</td>
                                            ...
                                            <td>
                                                <a class="btn btn-warning btn-sm" href="uredi.php?id=' . $line['id'] .'">Uredi</a>
                                                <a class="btn btn-danger btn-sm" href="delete.php?id=' . $line['id'] . '">Obriši</a>
                                            </td>
                                    </tr>';
                        }
